...
doucment.addEventListener("DOMContentLoaded", function (){console.log("✅ Step 1 clicked");
});
...
function calculateStats() {
    ...
    output.innerHTML =
    "Total Marks = <b>" + total + "</b><b>" + "Average Marks = <b>" + average.toFixed(2) + "</b>";
}
...
function countPassFail() {
    ...
    output.innerHTML =
    "Total PASS = <b>" + pass + "</b><b>" + "Total FAIL = <b>" + fail + "</b>";
}
